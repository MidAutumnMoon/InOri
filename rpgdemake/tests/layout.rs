...
impl Layout {
    ...
    fn setup_layout(&self) {
        ...
        let mapping = match self.version {
            Version::MV => [
                ("img/pictures/Clouds.rpgmvp", fixture("Clouds.rpgmvp")),
                ("audio/bgm/Castle1.rpgmvo", fixture("Castle1.rpgmvo")),
            ],
            Version::MZ => [
                ("img/pictures/Clouds.png_", fixture("Clouds.rpgmvp")),
                ("audio/bgm/Castle1.ogg_", fixture("Castle1.rpgmvo")),
            ],
        };
        mapping
            .into_iter()
    ...
    fn setup_expected(&self) {
        let dir = self.base_dir();
        let mapping = [
            ("img/pictures/Clouds.png", fixture("Clouds.png")),
            ("audio/bgm/Castle1.ogg", fixture("Castle1.ogg")),
        ];
        mapping
            .into_iter()
            .map(|(child, src_path)| {
